...
impl FromRequest for Auth {
    ...
    fn from_request(req: &HttpRequest, _: &mut Payload) -> Self::Future {
        ...
        Box::pin(async move {
            ...
            let espo_user = EspoUser::get_by_id(&espo_client, &token_info.espo_user_id).await
